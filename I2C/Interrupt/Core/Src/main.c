...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	UART_Print("I2C Interrupt Demo Start\r\n\r\n");

	/* Step 1: Read WHO_AM_I using polling */
											 ...
											 100) == HAL_OK)
	{
			...
			{
					UART_Print("MPU6500 not detected.\r\n");
			}
	}
	else
	{
	...
	/* Step 2: Write PWR_MGMT_1 using polling */
	writeData = 0x00;
	...
	if (HAL_I2C_Mem_Write(&hi2c1,
												...
												100) == HAL_OK)
	{
			UART_Print("PWR_MGMT_1 write done.\r\n");
	}
	else
	{
			UART_Print("PWR_MGMT_1 write failed.\r\n");
	}
	...
	/* Step 3: Start first acceleration read using interrupt */
	Start_Accel_Read_IT();
